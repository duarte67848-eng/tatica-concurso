      ...
      {activeTab === "analise" && (
        ...
        {activeTab === "ranking" && (
          <div style={{ background: c.backgroundSecondary, border: `1px solid ${c.border}`, borderRadius: "8px", padding: "1.5rem" }}>
            ...
            <div style={{ marginBottom: "1rem", color: "#f00", fontSize: "0.875rem" }}>DEBUG: rankingLoading={String(rankingLoading)}, ranking.length={ranking.length}, data={JSON.stringify(ranking)}</div>
            {rankingLoading ? (
